...
export const INITIAL_IDEAS: ProjectIdea[] = [
  ...
  },
  {
    ...
    team: [],
    session: 'Morning',
    shortDescription: 'Virtual reality tour of the campus grounds...',
    fullDescription: 'An immersive VR experience allowing prospective students to tour the campus from home. Built using Unity and available on Oculus Quest.',
    status: 'Accepted',
    progress: 90,
